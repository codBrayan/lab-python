...
# - player
imagePLayer_right = pygame.image.load("projetoPygame1\pyfiles\player_rightMove.png")
imagePlayer_left = pygame.image.load("projetoPygame1\pyfiles\player_leftMove.png")
...
# - zombies
imageZombie = pygame.image.load("projetoPygame1\pyfiles/zombie.png")
widthZombie = 30
heightZombie = 40
firstLifeZombie = 5

blood = pygame.image.load("projetoPygame1\pyfiles/blood.png")
